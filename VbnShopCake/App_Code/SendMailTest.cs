...
namespace Library.Tools
{
    ...
    public class SendMailTest
    {
        ...
        public SendMailTest(string from, string to, string subject, string body)
        {
            From = from;
            To = to;
            Subject = subject;
        ...
        public SendMailTest(string from, string to, string cc, string bcc, string subject, string body)
        {
            From = from;
            To = to;
            Cc = cc;
        ...
        public SendMailTest(string from, string to, string cc, string bcc, string subject, string body, string configFile)
        {
            From = from;
            To = to;
            Cc = cc;
        ...
        public void Send2()
        {
            Send2("VbnShopCake", "vbnshop@gmail.com", From, To, Cc, Bcc, Subject, Body, ConfigFile_info);
        }
