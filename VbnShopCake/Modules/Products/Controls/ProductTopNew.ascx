<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductTopNew.ascx.cs"
    Inherits="Modules_Products_Controls_ProductTopNew" %>
<div class="listProducts">
    ...
    <p class="more">
        <a href='<%= Modules.Catalogs.UrlBuilder.GetCatsByIdTextId(CatId, Request["TextId"]) %>'
