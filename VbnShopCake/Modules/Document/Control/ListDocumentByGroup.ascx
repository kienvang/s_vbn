<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListDocumentByGroup.ascx.cs"
    Inherits="Modules_Document_Control_ListDocumentByGroup" %>
...
<div class="listProducts">
    ...
    <asp:DataList ID="listByGroup" runat="server" RepeatColumns="3">
        <ItemTemplate>
            <div class="display">
...
<div style="clear: both">
    <% if (CountDoc >= 12)
       { %>
    <a href='<%= Modules.Document.UrlBuilder.ListAllDocumentByGroup(IntId,Name)%>' style="float: right">
        Xem thêm</a>
    <%}
       else if (CountDoc == 0)
       { %>
