<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TopNew.ascx.cs" Inherits="Modules_Document_Control_TopNew" %>
...
<div style="clear: both">
    <% if (CountDoc >= 12)
       { %>
    <a href='<%= Modules.Document.UrlBuilder.ListAllDocument() %>' style="float: right">
        Xem thêm</a>
    <%}
       else if (CountDoc == 0)
       { %>
